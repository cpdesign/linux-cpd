...
static long mxc_pf_ioctl(struct file *filp,
...
int mxc_pf_fsync(struct file *filp, loff_t off1, loff_t off2, int datasync)
{
	flush_cache_all();
	outer_flush_all();
	return 0;

...
static struct mc13xxx_buttons_platform_data vpr200_pwrbuttons = {
	.b1on_flags = MC13XXX_BUTTON_ENABLE | MC13XXX_BUTTON_DBNC_750MS,
	.b1on_key = KEY_RESERVED,
};
